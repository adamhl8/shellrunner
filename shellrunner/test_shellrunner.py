...
class TestOptions:
    ...
    def test_show_commands_false(self, shell: str, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_show_output_false_show_commands_false(self, shell: str, capsys: pytest.CaptureFixture[str]) -> None:
